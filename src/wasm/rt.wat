(module
  ...
  (func $memory_copy (export "memory_copy") (param $src i32) (param $dst i32) (param $len i32)
    (local $src_end i32)
  ...
  (func $pair_new (export "pair_new") (param $first i32) (param $second i32) (result i64)
    (i64.or
      (i64.shl
  ...
  (func $pair_first (export "pair_first") (param $val i64) (result i32)
    (i32.wrap_i64
      (i64.shr_u
        (local.get $val)
        (i64.const 32)
  ...
  (func $pair_second (export "pair_second") (param $val i64) (result i32)
    (i32.wrap_i64
      (local.get $val)
    )
  )
  (func $string_new (export "string_new") (param $ptr i32) (param $len i32) (result i64)
    (call $pair_new (local.get $ptr) (local.get $len))
  )
  (func $string_add (export "string_add") (param $lhs i64) (param $rhs i64) (result i64)
    (local $ptr i32)
    (local $len i32)
